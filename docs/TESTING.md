...
- No controller-layer (MockMvc / HTTP) tests yet for the Resource API — routes are exercised manually via REST client during development, not yet asserted in an automated test.
